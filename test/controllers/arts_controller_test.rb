...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { pic_url: @art.pic_url, purchase_at: @art.purchase_at, title: @art.title }
    end
  ...
  test "should update art" do
    patch :update, id: @art, art: { pic_url: @art.pic_url, purchase_at: @art.purchase_at, title: @art.title }
    assert_redirected_to art_path(assigns(:art))
  end
